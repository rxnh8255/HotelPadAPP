...
import com.zhijiaiot.app.signalr4j.transport.AutomaticTransport;
import com.zhijiaiot.app.signalr4j.transport.ClientTransport;
import com.zhijiaiot.app.signalr4j.transport.ConnectionType;
import com.zhijiaiot.app.signalr4j.transport.DataResultCallback;
import com.zhijiaiot.app.signalr4j.transport.NegotiationResponse;
import com.zhijiaiot.app.signalr4j.transport.TransportHelper;
    ...
    private void startTransport(KeepAliveData keepAliveData, final boolean isReconnecting) {
        synchronized (mStartLock) {
            ...
            SignalRFuture<Void> future = mTransport.start(this, connectionType, new DataResultCallback() {
                @Override
                public void onData(String data) {
                    log("Received data: "+data, LogLevel.Verbose);
